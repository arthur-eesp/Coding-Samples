### Question 5 - Part 2: placebo periods ###
...
for (i in seq_along(outcomes)){
  ...
  dt_sc[, treatment := ifelse(STATEFIP == 6 & YEAR > 2003, 1, 0)]
...
for (i in seq_along(outcomes)){
  ...
  # Define treatment dummy
  dt_sc[, treatment := ifelse(STATEFIP == 6 & YEAR > 2004, 1, 0)]
...
kbl(data.table(group, rbind(g1_mat, g2_mat, g3_mat)),
    ...
    booktabs = TRUE,
    digits = 3,
    caption = "Placebo SC estimates setting treatment period 2 years prior
