### Question 5 - Part 1: SC estimation ###
...
kbl(data.table(group, rbind(g1_mat, g2_mat, g3_mat)), 
    ...
    booktabs = TRUE,
    digits = 3,
    caption = "SC estimates of impact of California's PFL program on labor
